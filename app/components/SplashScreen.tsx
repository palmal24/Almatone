...
export default function SplashScreen({ onFinish }: SplashScreenProps) {
  ...
  useEffect(() => {
    ...
    const preloadAssets = Asset.loadAsync([
      ...
      require('../../assets/sounds/calm/gentle_rain.mp3'),
      require('../../assets/sounds/calm/ocean_waves.mp3'),
      require('../../assets/sounds/calm/river_flow.mp3'),
      require('../../assets/sounds/calm/waterfal.mp3'),
    ]);
