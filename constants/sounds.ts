export const SOUNDS = {
  ...
  gentle_rain: {
    icon: require('@assets/images/icons/gentle_rain.png'),
    audio: require('@assets/sounds/calm/gentle_rain.m4a'),
  },
  heavy_rain: {
    icon: require('@assets/images/icons/waterfall.png'),
    audio: require('@assets/sounds/calm/heavy_rain.m4a'),
  },
  ocean_waves: {
    icon: require('@assets/images/icons/ocean_waves.png'),
    audio: require('@assets/sounds/calm/ocean_waves.m4a'),
  },
  river_flow: {
    icon: require('@assets/images/icons/river_flow.png'),
    audio: require('@assets/sounds/calm/river_flow.m4a'),
  },
  waterfall_short: {
    icon: require('@assets/images/icons/waterfall.png'),
    audio: require('@assets/sounds/calm/waterfall_short.m4a'),
  },
  waterfall: {
    icon: require('@assets/images/icons/waterfall.png'),
    audio: require('@assets/sounds/calm/waterfall.m4a'),
  },
};
